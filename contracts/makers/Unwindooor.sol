...
contract Unwindooor is Auth {
    ...
    ISavmswapV2Factory public immutable factory;
    ...
    constructor(
        ...
        factory = ISavmswapV2Factory(factoryAddress);
    }
    ...
    function unwindPairs(
        ...
        for (uint256 i = 0; i < tokensA.length; i++) {
            ...
            if (_unwindPair(ISavmV2(pair), amounts[i], keepToken0, tokenB) < minimumOuts[i]) revert SlippageProtection();
        }
    }
